...
internal fun CustomizedTopAppBar(
    ...
    SingleRowTopAppBar(
        modifier = modifier,
        title = { Title(title = title, maxLines = 1) },
...
@Composable
internal fun defaultTopAppBarColors() =
    TopAppBarColors(
 ...
 */
@Stable
internal data class TopAppBarColors(
...
internal val MaxHeightWithoutTitle = if (false) 84.dp else 124.dp
internal val DefaultTitleHeight = 52.dp
internal val ContainerHeight = 56.dp
private val titleBaselineHeight = if (false) 8.dp else 0.dp
